        ...
        >
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '3rem', marginTop: '2rem' }}>
            ...
            >
              ...
              <p style={{ fontSize: '0.9rem', color: '#94a3b8' }}>Tax Saved</p>
            </motion.div>
            ...
            <motion.div
              ...
              style={{ textAlign: 'center' }}
            >
              <div style={{ fontSize: '2.5rem', fontWeight: 'bold', color: '#14b8a6' }}>
                <AnimatedCounter end={68} duration={1500} />+
              </div>
              <p style={{ fontSize: '0.9rem', color: '#94a3b8' }}>AI Agents</p>
            </motion.div>
            ...
            >
              ...
              <p style={{ fontSize: '0.9rem', color: '#94a3b8' }}>Market</p>
            </motion.div>
          </div>
        </motion.div>
          ...
          >
            <div style={{ position: 'relative', zIndex: 1 }}>
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: '1.5rem' }}>
                ...
                <h3 style={{ fontSize: '1.5rem', color: '#a855f7' }}>Proven Results</h3>
              </div>
              ...
              <div style={{ marginTop: '1.5rem', paddingTop: '1.5rem', borderTop: '1px solid rgba(168, 85, 247, 0.2)' }}>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1rem', textAlign: 'center' }}>
                  <div>
                    ...
                    <p style={{ fontSize: '0.75rem', color: '#94a3b8', marginTop: '0.5rem' }}>Live</p>
                  </div>
                  <div>
                    <CircularProgress value={100} size={40} strokeWidth={3} />
                    <p style={{ fontSize: '0.75rem', color: '#94a3b8', marginTop: '0.5rem' }}>Tested</p>
                  </div>
                  <div>
                    <CircularProgress value={100} size={40} strokeWidth={3} />
                    <p style={{ fontSize: '0.75rem', color: '#94a3b8', marginTop: '0.5rem' }}>Ready</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          >
            <div style={{ position: 'relative', zIndex: 1 }}>
              <div style={{ display: 'flex', alignItems: 'center', marginBottom: '1.5rem' }}>
                ...
                <h3 style={{ fontSize: '1.5rem', color: '#14b8a6' }}>Growth Path</h3>
              </div>
                  ...
                  >
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                      ...
                      <div style={{ textAlign: 'right' }}>
                        <div style={{ fontSize: '1.3rem', fontWeight: 'bold', color: '#14b8a6' }}>{item.value}</div>
                        <div style={{ fontSize: '0.75rem', color: '#6ee7b7' }}>{item.trend}</div>
                      </div>
                    </div>
                  </motion.div>
                ))}
              ...
              >
                <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', height: '60px' }}>
