...
const Slide7WealthMatrixProblemOnly = () => {
                ...
                >
                  <div style={{
                    ...
                    <div style={{ 
                      ...
                      <p style={{ 
                        fontSize: '12px', 
                        color: quadrant.color === '#fbbf24' ? '#fbbf24' : '#9ca3af',
                        fontWeight: '600',
                        margin: 0 
                      }}>
                        {quadrant.percentage}
        ...
        <div style={{ marginTop: '32px', textAlign: 'center', zIndex: 10 }}>
          <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '24px', textAlign: 'left' }}>
              <div>
                <h4 style={{ color: '#10b981', fontWeight: 'bold', fontSize: '14px', marginBottom: '8px' }}>
                  WANT ACCESS?
                </h4>
              ...
              <div>
                <h4 style={{ color: '#a855f7', fontWeight: 'bold', fontSize: '14px', marginBottom: '8px' }}>
                  WANT INTELLIGENCE?
                </h4>
                <p style={{ color: '#d1d5db', fontSize: '13px', lineHeight: '1.5' }}>
            ...
            <div style={{
              ...
              <p style={{ fontSize: '16px', color: '#fbbf24', marginTop: '8px' }}>
...
export default Slide7WealthMatrixProblemOnly;
