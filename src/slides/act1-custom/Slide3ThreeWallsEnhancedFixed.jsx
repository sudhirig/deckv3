...
const Slide3ThreeWallsEnhancedFixed = () => {
  return (
    <AspectFrame>
      <div style={{
        position: 'relative',
        width: '100%',
        height: '100%',
        background: 'linear-gradient(135deg, #1a1a1a 0%, #7f1d1d 50%, #1a1a1a 100%)',
        display: 'flex',
        ...
        <div style={{ textAlign: 'center', marginBottom: '32px', zIndex: 10 }}>
          <h1 style={{ 
            ...
            <span style={{ 
              background: 'linear-gradient(to right, #ef4444, #fb923c, #fbbf24)',
              WebkitBackgroundClip: 'text',
              WebkitTextFillColor: 'transparent'
            }}>
              THREE WALLS
            </span>
            <span style={{ color: 'white' }}> BETWEEN YOU AND </span>
            <span style={{ color: '#10b981' }}>ALPHA</span>
          </h1>
        ...
        {/* Total Cost Banner */}
        <div style={{
          background: 'linear-gradient(135deg, rgba(239, 68, 68, 0.15), rgba(251, 146, 60, 0.15), rgba(251, 191, 36, 0.15))',
          backdropFilter: 'blur(10px)',
          borderRadius: '16px',
          padding: '32px',
          ...
          <div style={{ textAlign: 'center' }}>
            <p style={{ fontSize: '20px', color: '#d1d5db', marginBottom: '12px' }}>
              Total Cost to Your $10M Portfolio:
            </p>
            <div style={{ fontSize: '64px', fontWeight: 'bold', color: 'white', marginBottom: '12px' }}>
              $190,000
              <span style={{ fontSize: '24px', color: '#9ca3af', marginLeft: '12px' }}>/ YEAR</span>
            </div>
...
export default Slide3ThreeWallsEnhancedFixed;
