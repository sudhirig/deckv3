      ...
      >
        ...
        <AnimatedText delay={0.2}>
          ...
          <p style={{ fontSize: '1.1rem', color: '#94a3b8', textAlign: 'center', marginBottom: '2rem' }}>
            The Innovator's Dilemma: They're structurally unable to compete
          </p>
        </AnimatedText>

        {/* Incumbents Analysis Grid */}
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '1.5rem', marginBottom: '2rem' }}>
          {incumbentWeaknesses.map((incumbent, index) => (
            <motion.div
              key={incumbent.category}
