    ...
    <AspectFrame>
      <div style={{
        ...
        <div style={{
          ...
          <DollarSign size={28} color="#14B8A6" style={{ marginBottom: '6px' }} />
          <p style={{
            fontSize: '36px',
            fontWeight: '700',
            color: '#14B8A6',
...
export default Slide2DualGapV7Fixed
