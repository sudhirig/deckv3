  ...
  const cards = [
    ...
    >
      ...
      <div style={{ fontSize: '1rem', lineHeight: '1.7' }}>
        <div style={{ background: 'rgba(59, 130, 246, 0.1)', padding: '1rem', borderRadius: pxToRem(8), marginBottom: '1rem' }}>
        ...
        <div style={{ background: 'rgba(59, 130, 246, 0.1)', padding: '1rem', borderRadius: pxToRem(8) }}>
    ...
    >
      ...
      <div style={{ fontSize: '1rem', lineHeight: '1.7' }}>
        <div style={{ background: 'rgba(34, 197, 94, 0.1)', padding: '1rem', borderRadius: pxToRem(8), marginBottom: '1rem' }}>
        ...
        <div style={{ background: 'rgba(34, 197, 94, 0.1)', padding: '1rem', borderRadius: pxToRem(8) }}>
    ...
    >
      ...
      <div style={{ fontSize: '1rem', lineHeight: '1.7' }}>
        <div style={{ background: 'rgba(20, 184, 166, 0.1)', padding: '1rem', borderRadius: pxToRem(8), marginBottom: '1rem' }}>
        ...
        <div style={{ background: 'rgba(20, 184, 166, 0.1)', padding: '1rem', borderRadius: pxToRem(8) }}>
