...
import { Globe, Calculator, Database, Cpu } from 'lucide-react'
    ...
    <div className="slide-content" style={{ position: 'relative', padding: '3rem 4rem' }}>
      ...
      <div style={{
        ...
        >
          ...
          <div style={{
            ...
            height: '200px',
            marginTop: '2rem',
            background: 'linear-gradient(180deg, rgba(59, 130, 246, 0.2), rgba(96, 165, 250, 0.1))',
            borderRadius: '10px'
          }}></div>
        </motion.div>
      ...
      >
        ...
        <motion.div 
          ...
          transition={{ type: "spring", stiffness: 300 }}
        >
          <Cpu size={20} color="#60a5fa" style={{ marginBottom: '0.5rem' }} />
