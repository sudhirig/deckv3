...
export default function AlternativeAIDDSlide() {
  return (
    <div className="slide-content">
      ...
      >
        <h2 className="slide-title">Our "Alternative Asset" Agent: AI Due Diligence</h2>
        <p className="slide-subtitle" style={{ marginBottom: '2rem' }}>Unlocking Private Markets</p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '3rem', marginTop: '2rem' }}>
          <div>
            ...
            <div style={{ background: 'rgba(239, 68, 68, 0.1)', padding: '2rem', borderRadius: '12px', fontSize: '1.2rem', lineHeight: '1.8' }}>
