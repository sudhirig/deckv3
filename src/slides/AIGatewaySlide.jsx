...
export default function AIGatewaySlide() {
  const cards = [
    <div key="experience">
      ...
      <motion.div 
        style={{ background: 'rgba(20, 184, 166, 0.05)', padding: '1.5rem', borderRadius: '0.75rem', marginBottom: '1.5rem' }}
      ...
      <motion.div 
        style={{ background: 'rgba(20, 184, 166, 0.1)', padding: '1.5rem', borderRadius: '0.75rem', marginBottom: '1.5rem' }}
        initial={{ opacity: 0, y: 1.25 }}
        animate={{ opacity: 1, y: 0 }}
    ...
    <div key="capabilities">
      ...
      <div style={{ fontSize: '1.1rem', lineHeight: '1.8' }}>
        <motion.div 
          style={{ marginBottom: '1.5rem', background: 'rgba(20, 184, 166, 0.05)', padding: '1.5rem', borderRadius: '0.75rem' }}
        ...
        <motion.div 
          style={{ background: 'rgba(20, 184, 166, 0.05)', padding: '1.5rem', borderRadius: '0.75rem' }}
          initial={{ opacity: 0, x: 1.875 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ delay: 0.4 }}
          whileHover={{ scale: 1.02 }}
      ...
      <motion.p 
        style={{ textAlign: 'center', fontSize: '1.1rem', color: '#fbbf24', marginTop: '2rem', fontWeight: 'bold' }}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
