...
export default function PartnershipStrategy2Slide() {
  ...
  const cards = giftCityAdvantages.map((advantage, index) => (
    ...
    >
      <div style={{
        ...
        <h4 style={{ color: advantage.color, fontSize: '0.9rem', margin: 0 }}>
          {advantage.category}
        </h4>
      </div>
  ...
  const summary = (
    <>
      ...
      >
        <h3 style={{ color: '#60a5fa', marginBottom: '1.5rem', fontSize: '1.1rem', marginTop: 0 }}>
      ...
      >
        <p style={{ fontSize: '1.1rem', color: '#4ade80', margin: 0 }}>
