    ...
    >
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem', marginTop: '2rem' }}>
        <motion.div 
          ...
          style={{ textAlign: 'center', padding: '1.5rem', background: 'rgba(59, 130, 246, 0.2)', borderRadius: '12px' }}
        >
        ...
        <motion.div 
          ...
          style={{ textAlign: 'center', padding: '1.5rem', background: 'rgba(34, 197, 94, 0.2)', borderRadius: '12px' }}
        >
        ...
        <motion.div 
          ...
          style={{ textAlign: 'center', padding: '1.5rem', background: 'rgba(20, 184, 166, 0.2)', borderRadius: '12px' }}
        >
        ...
        <motion.div 
          ...
          style={{ textAlign: 'center', padding: '1.5rem', background: 'rgba(251, 191, 36, 0.2)', borderRadius: '12px' }}
        >
  ...
  const keyInsights = (
    ...
    >
      ...
      <div style={{ display: 'grid', gap: '1.2rem' }}>
        <div style={{ padding: '1.5rem', background: 'linear-gradient(135deg, rgba(147, 51, 234, 0.1), rgba(124, 58, 237, 0.1))', borderRadius: '12px', borderLeft: '3px solid #9333ea' }}>
        ...
        <div style={{ padding: '1.5rem', background: 'linear-gradient(135deg, rgba(236, 72, 153, 0.1), rgba(219, 39, 119, 0.1))', borderRadius: '12px', borderLeft: '3px solid #ec4899' }}>
        ...
        <div style={{ padding: '1.5rem', background: 'linear-gradient(135deg, rgba(251, 146, 60, 0.1), rgba(249, 115, 22, 0.1))', borderRadius: '12px', borderLeft: '3px solid #fb923c' }}>
